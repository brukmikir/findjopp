...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5">
            ...
            <form action="{{ route('jop.store') }}" method="POST" enctype="multipart/form-data">@csrf
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        ...
                        {{$listing->jop_type === 'Fulltime' ? 'checked':''}}>
                    ...
                    <div class="form-check">
                        ...
                        {{$listing->jop_type === 'Parttime' ? 'checked':''}}>
                    ...
                    <div class="form-check">
                        ...
                        {{$listing->jop_type === 'Casual' ? 'checked':''}}>
                    ...
                    <div class="form-check">
                        ...
                        {{$listing->jop_type === 'Contract' ? 'checked':''}}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="date" id="datepicker" class="form-control" value="{{$listing->application_clos_date}}">
                    @if($errors->has('date'))
